...
var baseEndpoint = "wss://5d00-70-229-12-186.ngrok-free.app";
;
;
;
    ...
    function AudioWsClient(audioWsConfig) {
        ...
        _this.ws.onmessage = function (event) {
            ...
            try {
                ...
                if ((data === null || data === void 0 ? void 0 : data.event) === "mark") {
                    _this.marks.push((_a = data === null || data === void 0 ? void 0 : data.mark) === null || _a === void 0 ? void 0 : _a.name);
